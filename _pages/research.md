...
<br>
![Study sites for TIF development](/images/TIF_results.png){:height="88%" width="88%"}
<br>
**Fig. 1.** Study regions used for TIF calibration and validation across the United States. Background: 2021 NLCD land cover.

<br>
![TIF workflow of 10-m Landsat and Sentinel-2 time series](/images/tif-figure2.jpg){:height="90%" width="90%"}
<br>
